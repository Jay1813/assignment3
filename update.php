...
<html lang="en">
  ...
  <body class="container">
    ...
    <form class="form-group" action="data.php" method="post">
        ...
        <br>
        <input type="text" name="pg" placeholder="Page name here" class="form-control" value="<?php echo $row['pg']; ?>">
        <br>
        ...
        <br>
        <input type="text" name="p1" placeholder="P1 here" class="form-control" value="<?php echo $row['p1']; ?>">
        <br>
        <label>Paragraph 2:</label>
        <br>
        <input type="text" name="p2" placeholder="P2 here" class="form-control" value="<?php echo $row['p2']; ?>">
        <br>
        <label>Paragraph 3:</label>
        <br>
        <input type="text" name="p3" placeholder="P3 here" class="form-control" value="<?php echo $row['p3']; ?>">
        <br>
